...
const EventDisplay = () => {
    ...
    const { isLoading, data: event, error, refetch } = useQuery<Event>({
...
const styles = StyleSheet.create({
    ...
    modalButton: { borderWidth: 1, borderColor: '#ccc', borderRadius: 8, padding: 12, alignItems: 'center', marginBottom: 8 },
    ...
    guestRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#eee' },
